<div class="modal-header">
    ...
    <h2 class="modal-title" id="myModalLabel">Form Quality Control Material</h2>
</div>
<div class="modal-body">
	@if(isset($pm))
		{!! Form::model($pm, array('url'=> URL::to('scheme/pm/update/'.$pm->id), 'class'=>'form-horizontal', 'enctype' => 'multipart/form-data')) !!}
	@else
		{!! Form::open(array('url' => 'scheme/pm/store', 'class' => 'form-horizontal', 'enctype' => 'multipart/form-data')) !!}
	@endif
	<div class="row">
        ...
        <div class="form-group col-md-12 ">
            ...
            <div class="col-md-8">
                <button type="submit" name="save" class="btn btn-primary pull-right btn-sm" value="save">{{isset($pm) ? "Update" : "Save"}}</button>
            </div>
        </div>
    </div>
</div>
